...
import { BASE_URL } from "../../settings/configs";
            ...
            <div className="container items-center max-w-6xl px-8 mx-auto xl:px-5">
                ...
                <div className="w-full md:w-1/2 md:px-3">
                    ...
                    <h1 className="text-2xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-4xl xl:text-4xl">
                        <span className="block md:inline">Inbox Mastery With Intelligent</span>
                        <span className="block text-primary xl:inline">Help You Build Faster.</span>
                    </h1>
                    <p className="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">
                            Boost your email productivity with our intelligent automation tool! Seamlessly integrated with Outlook, automate replies, personalize with dynamic templates, and schedule campaigns effortlessly.
                    </p>
                    <div className="relative flex flex-col sm:flex-row sm:space-x-4">
                        <NavLink to="#_" className="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-primary rounded-md sm:mb-0 hover:bg-indigo-700 sm:w-auto">
                        Try It Free
                        ...
                        <NavLink to="#_" className="flex items-center px-6 py-3 text-gray-500 bg-gray-100 rounded-md hover:bg-gray-200 hover:text-gray-600">
                        Learn More
                        </NavLink>
                    </div>
                    </div>
                ...
                <div className="w-full md:w-1/2">
                    <div className="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-md">
                        <img src="/static/img/home-banner.jpg" />
                    </div>
                </div>
                </div>
            </div>
